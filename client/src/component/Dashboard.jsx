...
const Dashboard = () => {
        ...
        <div className="space-y-8 animate-in fade-in duration-700">
          <header>
            ...
            <p className="text-slate-500 text-sm mt-1">
              Access your home services and society updates.
            </p>
          </header>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              <div className="space-y-2">
                ...
                <p className="text-white/80 max-w-md">
                  Raise a service request or report an issue directly to the
                  management team.
                </p>
              </div>
      ...
      content: (
        <div className="space-y-8 animate-in fade-in duration-700">
          <header>
            ...
            <p className="text-slate-500 text-sm mt-1">
              Real-time society monitoring and visitor tracking.
            </p>
          </header>
          ...
          <div className="ds-panel overflow-hidden">
            <div className="p-6 border-b border-slate-100 flex items-center justify-between">
              ...
              <span className="badge px-3 py-1 bg-green-100 text-green-700">
                System Online
              </span>
            </div>
              ...
              {[1, 2, 3, 4].map((i) => (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <button className="px-3 py-1.5 text-xs font-bold text-emerald-600 bg-emerald-50 rounded-lg">
                      Check In
                    </button>
                    <button className="px-3 py-1.5 text-xs font-bold text-slate-500 hover:bg-slate-100 rounded-lg">
                      Details
                    </button>
                  </div>
                </div>
        ...
        return {
          ...
          content: (
            <div className="p-12 text-center text-slate-500">
              Unauthorized Access or No Role Assigned.
            </div>
          ),
        };
    }
  ...
  return <LayoutWrapper navItems={navItems}>{content}</LayoutWrapper>;
};
