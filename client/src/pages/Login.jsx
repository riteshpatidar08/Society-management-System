        ...
        <div className="relative z-10">
          ...
          <div className="max-w-md">
            <h2 className="text-4xl font-bold text-white mb-6 leading-tight">
              Manage your society with <span className="text-primary-400">intelligence.</span>
            </h2>
            ...
            <div className="space-y-6">
              {[
                { title: 'Smart Visitor Management', desc: 'Pre-approve guests and track visitor entries in real-time.' },
                { title: 'Digital Maintenance', desc: 'Pay bills, track expenses, and view financial reports instantly.' },
                { title: 'Community Hub', desc: 'Connect with neighbors and stay updated with official notices.' }
              ].map((item, index) => (
        ...
        <div className="w-full max-w-md">
          <div className="md:hidden flex items-center gap-2 mb-8 justify-center">
            <div className="w-8 h-8 bg-sidebar rounded-ds-md flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
            </div>
          ...
          <div className="mb-10 text-center md:text-left">
            ...
            <p className="ds-subtle">Access your society management dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                </div>
                <input
                  id="email"
                  name="email"
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="overline-label" htmlFor="password">Password</label>
                <a href="#" className="text-[11px] font-medium text-primary-600 hover:underline">Forgot password?</a>
              </div>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
                </div>
                <input
                  id="password"
                  name="password"
            ...
            <div className="flex items-center">
              <input id="remember" type="checkbox" className="w-4 h-4 text-primary-600 border-slate-200 rounded-ds-md focus:ring-primary-500" />
              <label htmlFor="remember" className="ml-2 block text-[13px] text-slate-600 cursor-pointer">Remember this device</label>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-slate-100 text-center">
            <p className="ds-subtle text-sm">
              New to the society? <a href="#" className="font-bold text-primary-600 hover:underline">Request Access</a>
            </p>
          </div>
        </div>
      </div>
